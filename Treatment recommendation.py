...
def recommend_treatments_for_grade(grade):
    ...
    grade_treatments = df[df['Level'] == grade]['Treatment Recommendation'].tolist()
...
# Example usage: Recommend treatments for each grade
grades_to_predict = df['Level'].unique()
for grade in grades_to_predict:
    recommend_treatments_for_grade(grade)